    ...
    <footer className="section-pad bg-[#0B0C10] pb-10 pt-16">
      <div className="grid gap-10 md:grid-cols-4">
        ...
        <nav aria-label="Company">
          ...
          <ul className="mt-4 space-y-2.5">
            <li>
              <Link to="/about" className="text-sm text-white/70 hover:text-[#00D4FF]">
                About ECA Networks
              </Link>
            </li>
            <li>
              <Link to="/services" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Services and support
              </Link>
            </li>
            <li>
              <Link to="/projects" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Projects
              </Link>
            </li>
            <li>
              <Link to="/team" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Team and careers
              </Link>
            </li>
            <li>
              <Link to="/esg" className="text-sm text-white/70 hover:text-[#00D4FF]">
                ESG and sustainability
              </Link>
            </li>
            <li>
              <Link to="/insights" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Insights
              </Link>
            </li>
            <li>
              <Link to="/price-list" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Price list
              </Link>
            </li>
            <li>
              <Link to="/privacy" className="text-sm text-white/70 hover:text-[#00D4FF]">
                Privacy and terms
              </Link>
            </li>
          </ul>
        ...
        <address className="space-y-3 not-italic">
          ...
          <p className="flex items-center gap-2.5 text-sm text-white/70">
            ...
            <a href={`mailto:${COMPANY.email}`} className="hover:text-[#00D4FF]">
              {COMPANY.email}
            </a>
          </p>
          <p className="flex items-start gap-2.5 text-sm text-white/70">
